export const translations = {
  ...
  ha: {
    ...
    home: {
      ...
      problem_desc_long: 'Muna yaki da juriyar magani da magungunan jabu a Najeriya ta hanyar ba da ingantaccen ilimi, tabbatarwa, da kuma biye diddigin magani.',
      get_started: 'Fara Yanzu',
      stat_label_1: 'Yan Najeriya Da Aka Kare',
      stat_label_2: 'Magungunan Jabu Da Aka Gano',
      stat_label_3: 'Ingancin Tabbatarwa',
      impact_short: 'Kasance tare da dubun-dubatar yan Najeriya masu zabar magunguna masu kyau.',
      live_status: 'Kariyar Tana Nan',
      problem_title: 'Najeriya tana fuskantar babban rikicin kiwon lafiya',
      problem_desc: 'Abubuwa biyu masu hadari suna hallaka mutane a fadin kasar mu:',
      feature_title: 'Dandamali Guda daya. Mafita Guda Uku.',
      feature_desc_short_learn: 'Ingantaccen ilimi akan amfanin antibiotics da tsaron lafiya',
      feature_desc_short_verify: 'Tabbatar da ingancin magani sannan ka gano na jabu kafin ka sha',
      feature_desc_short_track: 'Tunatarwa na musamman don tabbatar da bin umarnin shan magani',
      start_learning: 'Fara Koyo Yau',
      resistance_title: 'Juriyar Antibiotics',
      resistance_desc: 'Shan antibiotics ba tare da bukatar sa ba, rashin gama magani, da kuma kuskure sune ke haifar da juriyar magani. Wannan na mayar da cututtuka masu sauki su zama masu hadarin gaske.',
      fake_drug_title: 'Magungunan Jabu',
      fake_drug_desc: 'Kashi 30-40% na magungunan da ake sayarwa a kasuwan Najeriya na jabu ne. Marasa lafiya na amincewa da wadannan magungunan, sukan sha abubuwan da ba sa magani ko ma su bata musu lafiya.',
      stat_use: 'Amfani da antibiotics barkatai a Najeriya',
      stat_fake: 'Magungunan jabu a kasuwanni',
      stat_resistance: 'Ƙaruwar juriya daga rashin kammala magani',
      feature_desc: 'MedWise Nigeria na warware wadannan matsalolin ta hanyar ilimi, tabbatarwa, da kuma bin diddigi',
      impact_hero_title: 'Ilimi Na Canza Hali. Tabbatarwa Na Ceton Rayuka.',
      impact_hero_desc: 'Lokacin da marasa lafiya suka fahimci yadda ake amfani da antibiotics kuma suka tabbatar da magungunan su, juriya na raguwa kuma samun lafiya na karuwa.',
    },
    symptom: {
  ...
  yo: {
    ...
    home: {
      ...
      problem_desc_long: 'Ìjàṣẹ́ lòdì sí àrùn tó kọ ògùn (resistance) àti ògùn jábujábu nípasẹ̀ ẹ̀kọ́, ṣàyẹ̀wò oògùn, àti títẹ̀lé ìtọ́nilétí oògùn.',
      get_started: 'Bẹ̀rẹ̀ Ní báyìí',
      stat_label_1: 'Àwọn Ọmọ Nàìjíríà Tí A Dáàbò Bo',
      stat_label_2: 'Àwọn Ògùn Èké Tí A Rí Mu',
      stat_label_3: 'Ìpéye Ṣàyẹ̀wò',
      impact_short: 'Darapọ̀ mọ́ ẹgbẹẹgbẹ̀rún àwọn ọmọ Nàìjíríà tó ń yan ògùn tó dára.',
      live_status: 'Ààbò Tí O Wà Ní Ìkàlẹ̀',
      problem_title: 'Nàìjíríà ń dojú kọ wàhálà ìlera tó le',
      problem_desc: 'Awọn ewu nla meji kan n gba ẹmi awọn eniyan kọja orilẹ-ede wa:',
      feature_title: 'Ìpele Kan. Ìpinnu Mẹ́ta.',
      feature_desc_short_learn: 'Ẹ̀kọ́ gidi nípa bí a ṣe ń lo ògùn antibiotics, àti bí a ṣe lè yàgò fún àrùn tó kọ ògùn',
      feature_desc_short_verify: 'Ṣàyẹ̀wò oògùn rẹ nípa rẹ sẹ́ nọ́mbà NAFDAC láti mọ ògùn jábujábu kó o tó lò ó',
      feature_desc_short_track: 'Olùránnilétí tó péye láti rí i pé o tẹ̀lé ìtọ́sọ́nà oògùn rẹ kí o sì parí gbogbo dose rẹ',
      start_learning: 'Bẹ̀rẹ̀ sí ní Kọ́ Ẹ̀kọ́ Yìí',
      resistance_title: 'Àrùn Tó Kọ Ògùn (Resistance)',
      resistance_desc: 'Lílo antibiotics láìsí ìwé oníṣègùn, àìparí ìtọ́jú, àti ìlòkúlò rẹ̀ ń dá àwọn bakitéríà tó lágbára gan-an sílẹ̀ tí kò tún ní í jẹ́ kí ògùn ṣiṣẹ́ mọ́. Àwọn àrùn kéékèèké ń di ohun tó lè gba ẹ̀mí ènìyàn.',
      fake_drug_title: 'Àwọn Ògùn Èké/Jábujábu',
      fake_drug_desc: 'Ìpín ọgbọ̀n sí ogójì (30-40%) àwọn ògùn ní ọjà orílẹ̀-èdè Nàìjíríà jẹ́ ògùn èké tàbí èyí tí kò dára. Àwọn aláìsàn ń fi gbogbo ara gba àwọn ògùn yìí gbọ́, wọ́n ń lo ohun tí kò ní í ṣiṣẹ́ tàbí tó máa ṣara wọn níṣẹ́.',
      stat_use: 'Lilo antibiotics ti ko to ni Naijeria',
      stat_fake: 'Ogun iro ni oja to le fa iku',
      stat_resistance: 'Àìsàn tó kọ ògùn nítorí àìparí rẹ̀',
      feature_desc: 'MedWise Nigeria dojú kọ àwọn ìṣòro yìí nípasẹ̀ ẹ̀kọ́ tó kúnfẹ́, ṣàyẹ̀wò ògùn, àti ìtìlẹ́yìn ìtọ́jú',
      impact_hero_title: 'Ẹ̀kọ́ Ń Yi Ìhùwà Padà. Ṣàyẹ̀wò Ń Gba Ẹ̀mí Là.',
      impact_hero_desc: 'Nígbà tí àwọn aláìsàn bá mọ bí a ṣe ń lo antibiotics daradara tí wọ́n sì lè ṣàyẹ̀wò ògùn wọn, àrùn tó kọ ògùn yóò dín kù, ìwòsàn yóò sì pọ̀ sí i.',
    },
    symptom: {
  ...
  ig: {
    ...
    home: {
      ...
      problem_desc_long: 'Anyị na-alụso nsogbu nguzogide ọgwụ na ọgwụ jabu ọgụ na Nigeria site n\'agụmagụ, nnyocha ọgwụ, na iso oge ojiji ọgwụ gị.',
      get_started: 'Malite Ugbu a',
      stat_label_1: 'Ndị Nigeria Anyị Chebere',
      stat_label_2: 'Ọgwụ Jabu Anyị Chọpụtara',
      stat_label_3: 'Ịkpọmkwem Nnyocha',
      impact_short: 'Sonyere puku kwuru puku ndị Nigeria na-ahọrọ ọgwụ dị mma.',
      live_status: 'Nchebe Na-arụ Ọrụ Ugbu a',
      problem_title: 'Nigeria na-eche nnukwu nsogbu ahụike ihu',
      problem_desc: 'Ihe egwu abụọ na-egbu ndị mmadụ n\'obodo anyị niile:',
      feature_title: 'Otu Ikpo okwu. Ngwọta Atọ.',
      feature_desc_short_learn: 'Agụmagụ banyere ojiji ọgwụ antibiotics, nguzogide, na nchebe ọgwụ gị',
      feature_desc_short_verify: 'Nwalee ọgwụ gị iji chọpụta ọgwụ jabu ma ọ bụ nke eche eche tupu ị nụọ ya',
      feature_desc_short_track: 'Ihe ncheta iji hụ na ị na-enweta ọgwụ gị n\'oge ma mechaa usoro niile nke ọma',
      start_learning: 'Malite Mmụta Taa',
      resistance_title: 'Nguzogide Ọgwụ (Resistance)',
      resistance_desc: 'Iwere antibiotics na-enweghị akwụkwọ dọkịta, usoro ọgwụ akwụsịrị na mkpụ, na ojiji ezighi ezi na-emepụta nje bacteria siri ike nke ọgwụ na-agaghịzi anụ. Ọrịa ndị dị mfe na-aghọzi ihe egwu na ndụ.',
      fake_drug_title: 'Ọgwụ Adịgboroja/Jabu',
      fake_drug_desc: 'Pasent 30-40% ọgwụ dị n\'ahịa Nigeria bụ ọgwụ jabu ma ọ bụ ndị adịghị mma. Ndị ọrịa na-atụkwasị ọgwụ ndị a obi, na-aṅụ ihe na-anaghị agwọ ha ma ọ bụ na-emebi ahụ ha n\'amaghị ama.',
      stat_use: 'Ndị na-aṅụ antibiotics otú ọ bụla na Nigeria',
      stat_fake: 'Ọgwụ eche eche n\'ahịa nwere ike igbu mmadụ',
      stat_resistance: 'Nguzogide ọgwụ site na enweghị nụcha dose',
      feature_desc: 'MedWise Nigeria na-alụso nsogbu abụọ a ọgụ site na mmụta, nnyocha ọgwụ, na nkwado ọgwụgwọ',
      impact_hero_title: 'Mmụta Na-agbanwe Omume. Nnyocha Na-azọpụta Ndụ.',
      impact_hero_desc: 'Mgbe ndị ọrịa ghọtara ojiji kwesịrị ekwesị nke antibiotics wee nwee ike nyochaa ọgwụ ha, nguzogide ga-ebelata ma ohere ịgwọ ọrịa ga-abawanye.',
    },
    symptom: {
